({
    itemSelected : function(component, event, helper) {
        ...
        if(SelIndex){
            ...
            if(selItem.val){
                component.set("v.selItemVal",selItem.val);
    ...
    serverCall : function(component, event, helper) {
        ...
        if (event.keyCode == 27) {
            ...
            var entitlementId = component.get("v.entitlementId");
    ...
    handleResponse : function (res,component,helper){
        if (res.getState() === 'SUCCESS') {
            ...
            if(retObj.length <= 0){
                var noResult = JSON.parse('[{"text":"no record found"}]');
    ...
    clearSelection: function(component, event, helper){
        ...
        if(selItem != null && typeof selItem != 'undefined' && selItem.val != null && typeof selItem.val != 'undefined'){
            
        }
        component.set("v.selItem",null);
        component.set("v.server_result",null);
        component.set("v.selItemVal",null);
        
        
    },
    showToast : function(component, msgTitle,msg) {
